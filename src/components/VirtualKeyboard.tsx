...
const VirtualKeyboard = ({ onType, value, placeholder }: VirtualKeyboardProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="bg-gradient-to-b from-card/95 via-card to-card/98 backdrop-blur-xl border-t-4 border-primary/40 shadow-[0_-10px_50px_-10px_rgba(168,85,247,0.4)] p-4 max-w-lg">
        <DialogHeader>
